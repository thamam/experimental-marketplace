...
import type { VectorEmbedding } from '../storage/types.js';
...
export class SemanticSearch {
   ...
   */
  async search(query: string, memories: Memory[], topK: number = 10): Promise<SearchResult[]> {
   ...
   */
  async batchIndex(memories: Array<{ id: string; text: string }>): Promise<void> {
